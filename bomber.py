...
W='\033[0m'
# The Credit For This Code Goes To MOHAN MASS  MV
...
def infinite(pn, dl, ch, max):
    ...
    while True:
        ...
        count_inf += 1
        # os.system('echo MOHAN >> count.xxx')
        time.sleep(float(dl))
        if (count_inf > maxlim):
            exit()
        ...
        try:
            ...
            if cc == "91":
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To mohan326856@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
...
if type == 1:
    ...
    if cc == "91":
        nm = int(input("Enter Number of Messages To Send (for unlimited enter 0) : "))
        dl = float(
...
if cbomb:
    ...
    exit()
if nm == 0:
    nt = int(input("\tNumber Of Threads(100 to 200) : "))
    if nt <= 0 or nt >= 200:
